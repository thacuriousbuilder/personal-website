...
export const curiosityPosts: CuriosityPost[] = [
  {
    ...
    slug: 'why-i-love-building-side-projects',
    status: 'published',
    summary:
      'A reflection on the value of building indie apps and how it has shaped my thinking and career.',
